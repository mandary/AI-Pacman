...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for ghost, dist in enumerate(livingGhostPositionDistributions):
            ...
            if minDest is None or distance < minDest:
                minDest = distance
                minGhostPos = position
        # find best action
        actionDistances = [(a, self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, a), minGhostPos)) for a in legal]
